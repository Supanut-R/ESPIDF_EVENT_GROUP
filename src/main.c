...
#define SW1_GPIO_PIN GPIO_NUM_10 // SW1
#define SW2_GPIO_PIN GPIO_NUM_7 // SW2
#define D1_GPIO_PIN GPIO_NUM_4 // LED: D1 on my board
#define D2_GPIO_PIN GPIO_NUM_3 // LED: D2 on my board
#define D4_GPIO_PIN GPIO_NUM_1 // LED: D3 on my board
...
void app_main() {
    ...
    while(true) {
        ...
        EventBits_t uxBits = xEventGroupWaitBits(event_group, event_bit, pdTRUE, pdTRUE, portMAX_DELAY); //มีใคร set bit มารึป่าว โดยจะต้องเป็น bit ที่ตรงกับ event_group ที่ตั้งไว้
        // task 1
